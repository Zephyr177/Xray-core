...
type Config struct {
	...
	MultiPath           *MultiPathConfig       `protobuf:"bytes,4,opt,name=multi_path,json=multiPath,proto3" json:"multi_path,omitempty"`
...
func (x *Config) GetMultiPath() *MultiPathConfig {
	if x != nil {
		return x.MultiPath
	}
	return nil
...
func (x *MultiPathConfig) Reset() {
	*x = MultiPathConfig{}
	mi := &file_transport_internet_tcp_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MultiPathConfig) Descriptor() ([]byte, []int) {
	return file_transport_internet_tcp_config_proto_rawDescGZIP(), []int{1}
}
...
func (x *MultiPathConfig) GetConnectionCount() uint32 {
	if x != nil {
...
const file_transport_internet_tcp_config_proto_rawDesc = "" +
	"\n" +
	"#transport/internet/tcp/config.proto\x12\x1bxray.transport.internet.tcp\x1a!common/serial/typed_message.proto\"\xda\x01\n" +
	"\x06Config\x12I\n" +
	"\x0fheader_settings\x18\x02 \x01(\v2 .xray.common.serial.TypedMessageR\x0eheaderSettings\x122\n" +
	"\x15accept_proxy_protocol\x18\x03 \x01(\bR\x13acceptProxyProtocol\x12K\n" +
	"\n" +
	"multi_path\x18\x04 \x01(\v2,.xray.transport.internet.tcp.MultiPathConfigR\tmultiPathJ\x04\b\x01\x10\x02\"V\n" +
	"\x0fMultiPathConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12)\n" +
	"\x10connection_count\x18\x02 \x01(\rR\x0fconnectionCountBs\n" +
...
var file_transport_internet_tcp_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_transport_internet_tcp_config_proto_goTypes = []any{
	(*Config)(nil),              // 0: xray.transport.internet.tcp.Config
	(*MultiPathConfig)(nil),     // 1: xray.transport.internet.tcp.MultiPathConfig
	(*serial.TypedMessage)(nil), // 2: xray.common.serial.TypedMessage
}
var file_transport_internet_tcp_config_proto_depIdxs = []int32{
	2, // 0: xray.transport.internet.tcp.Config.header_settings:type_name -> xray.common.serial.TypedMessage
	1, // 1: xray.transport.internet.tcp.Config.multi_path:type_name -> xray.transport.internet.tcp.MultiPathConfig
